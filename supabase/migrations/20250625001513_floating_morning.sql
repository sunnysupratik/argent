/*
  # Complete Demo Users Setup with Sample Data

  1. New Tables
    - `profiles` - User profile information
    - `accounts` - User bank accounts
    - `categories` - Transaction categories (system and user-defined)
    - `transactions` - Financial transactions

  2. Demo Users
    - Alex Johnson (demo@example.com / Password123!)
    - Sarah Wilson (testuser@example.com / TestPass123!)
  ...
  4. Sample Data
    - Multiple accounts per user (checking, savings, investment, credit)
