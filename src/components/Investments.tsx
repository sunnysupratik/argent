    ...
    <div className="mobile-spacing lg:p-8 space-y-6 lg:space-y-8">
      ...
      <AnimatedSection className="mb-8 lg:mb-12">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start space-y-4 lg:space-y-0">
          <div>
            <h1 className="text-base md:text-lg lg:text-xl xl:text-2xl mb-2 font-bold uppercase tracking-wide">INVESTMENTS</h1>
            <motion.div 
            ...
            />
            <p className="text-gray-600 mt-2 text-xs md:text-sm lg:text-base">Monitor and manage your investment portfolio</p>
          </div>
