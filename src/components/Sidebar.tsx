...
const Sidebar: React.FC<SidebarProps> = ({ activeView, onViewChange }) => {
  ...
  return (
    <div className="w-full bg-white/80 backdrop-blur-xl border-b border-gray-200/50 relative overflow-hidden">
      ...
      <motion.div 
        className="px-6 lg:px-12 py-8 lg:py-12 border-b border-gray-200/30"
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            >
              <div className="text-3xl lg:text-4xl font-black tracking-tight text-text-primary">
                AR
            ...
            >
              ...
              <motion.button
                ...
                className="flex items-center space-x-2 px-4 py-3 rounded-xl bg-gray-50/80 hover:bg-gray-100/80 transition-all duration-200 backdrop-blur-sm border border-gray-200/30"
                whileHover={{ 
                  scale: 1.02,
              ...
              <motion.button
                ...
                className="flex items-center space-x-2 px-4 py-3 rounded-xl text-red-600 hover:bg-red-50/80 transition-all duration-200 backdrop-blur-sm border border-red-200/30"
                whileHover={{ 
                  scale: 1.02,
                  transition: { duration: 0.2 }
                }}
      ...
      <motion.div 
        className="px-6 lg:px-12 py-8 lg:py-12 bg-gradient-to-r from-accent-blue/3 via-indigo-50/20 to-violet-50/15 border-b border-gray-200/20"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div 
            className="text-left flex flex-col justify-center h-20 lg:h-24"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.8 }}
          >
            <div className="text-lg md:text-xl lg:text-2xl font-semibold text-gray-800 mb-3 tracking-wide">
              {getGreeting()}
            </div>
            <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 tracking-tight">
            ...
            <motion.div 
              className="w-20 md:w-24 lg:w-32 h-0.5 bg-gradient-to-r from-accent-blue to-blue-600 mt-4"
              initial={{ width: 0 }}
              animate={{ width: window.innerWidth >= 1024 ? 128 : window.innerWidth >= 768 ? 96 : 80 }}
      ...
      <div className="relative px-6 lg:px-12 py-8 lg:py-12">
        <div className="max-w-7xl mx-auto flex justify-center">
          <motion.div 
            ...
            className="w-full flex justify-center overflow-x-auto scrollbar-hide h-16 lg:h-20 items-center"
          >
