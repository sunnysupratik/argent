      ...
      <ul className="flex gap-2 md:gap-3 lg:gap-4 xl:gap-6 flex-wrap justify-center max-w-full">
        {menuItems.map(({ id, label, icon: Icon, gradientFrom, gradientTo, onClick, isActive }) => (
          <li
            ...
            className={`relative w-[40px] h-[40px] md:w-[45px] md:h-[45px] lg:w-[50px] lg:h-[50px] xl:w-[60px] xl:h-[60px] bg-white rounded-full flex items-center justify-center transition-all duration-500 ${
