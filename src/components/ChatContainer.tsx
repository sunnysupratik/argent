                ...
                >
                  ...
                  >
                    <div className="relative mb-6 lg:mb-8">
                      <motion.div 
                        className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-r from-accent-blue to-blue-600 rounded-2xl flex items-center justify-center mx-auto shadow-xl"
                        animate={{ 
                          boxShadow: [
                      ...
                      >
                        <Brain size={24} className="text-white lg:hidden" />
                        <Brain size={28} className="text-white hidden lg:block" />
                      </motion.div>
                    </div>
                    
                    <motion.h2 
                      className="text-xl lg:text-3xl font-bold text-gray-900 mb-3 tracking-tight"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    <motion.p 
                      className="text-sm lg:text-base text-gray-600 max-w-xl mx-auto leading-relaxed font-light"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                  ...
                  {/* Quick Action Cards */}
                  <motion.div 
                    className="grid grid-cols-1 lg:grid-cols-2 gap-3 w-full max-w-3xl"
                    ...
                    {quickPrompts.map((prompt, index) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border border-gray-200/50 hover:border-gray-300/50 rounded-xl p-3 lg:p-4 text-left transition-all duration-300 hover:shadow-lg"
        ...
        <form onSubmit={onSubmit} className="relative">
          <div className="relative flex items-center">
            <input
              ...
              disabled={isLoading}
              className="w-full py-2 lg:py-3 px-3 lg:px-4 pr-12 lg:pr-14 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-accent-blue focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed transition-all text-gray-900 placeholder-gray-500 text-sm lg:text-base"
              autoComplete="off"
            />
            <motion.button
              type="submit"
              disabled={!input.trim() || isLoading}
              className="absolute right-2 p-2 bg-accent-blue text-white rounded-lg hover:bg-accent-blue-hover disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md"
