...
const ContactForm: React.FC<ContactFormProps> = ({ onSuccess }) => {
  const { createLead, loading, error, success } = useLeads();
  ...
  if (success) {
    return (
      <motion.div
        ...
        className="bg-gradient-to-r from-green-50/5 to-emerald-50/5 border border-green-500/20 rounded-2xl p-8 text-center"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
  ...
  return (
    <motion.div
      ...
      className="bg-black/30 backdrop-blur-xl rounded-2xl border border-white/[0.08] p-6 lg:p-8"
    >
      <div className="mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-accent-blue transition-colors"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={handleInputChange}
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-accent-blue transition-colors"
            >
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={5}
            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-accent-blue transition-colors resize-none"
