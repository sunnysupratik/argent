...
const PricingPage: React.FC = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "$9.99",
      period: "per month",
      description: "Full access to your AI Analyst and advanced financial tools",
      icon: Zap,
      color: "from-accent-blue to-blue-600",
      features: [
        "Unlimited account connections",
        "Full AI Analyst access with chat interface",
    ...
    },
    {
      ...
      price: "$19.99",
      period: "per month",
      description: "Complete AI team: Analyst, Strategist, and Voice Advisor",
      icon: Crown,
      color: "from-purple-500 to-purple-600",
      features: [
        "Everything in Professional",
        "AI Analyst chat with unlimited queries",
        "AI Strategist video consultations (powered by Tavus)",
        "AI Voice Advisor (powered by ElevenLabs)",
